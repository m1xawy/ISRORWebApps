...
(function($, document){
    ...
    $.fn.scrollbar = function(opts){
        ...
        return this.each(function(){
            ...
            props.containerHeight = container.height() + parseFloat(container.css('padding-top'),10) + parseFloat(container.css('padding-bottom'),10);

            // determine inner content height
            props.contentHeight = 0;
            container.children().each(function(){
                props.contentHeight += $(this).outerHeight(true);
            });
    ...
    $.fn.scrollbar.defaults = {
        ...
        scrollStepArrows:  15           // handle increment between two mousedowns within the handle container [px]
    };
    ...
    $.fn.scrollbar.Scrollbar.prototype = {
        ...
        initHandle: function(){
            ...
            var contentHeight = 0;
            var paddingTop = parseFloat(this.pane.css('padding-top'),10);
            var paddingBottom = parseFloat(this.pane.css('padding-bottom'),10);
            this.pane.children().each(function(){
                contentHeight += $(this).outerHeight(true);
            });
            this.props.contentHeight = contentHeight + paddingTop + paddingBottom;
        ...
        startOfHandleMove: function(ev){
            ...
            this.handle.addClass('scrollbar-handle-move');
            this.handleContainer.addClass('scrollbar-handle-container-move');
        },
        ...
        endOfHandleMove: function(ev){
            ...
            this.handle.removeClass('scrollbar-handle-move');
            this.handleContainer.removeClass('scrollbar-handle-container-move');
        },
        ...
        onArrowsMousedown: function(ev){
            ...
            // add class for visual change while moving handle
            if(this.handle.direction == -1) $(ev.target).addClass('scrollbar-handle-up-move');
            else $(ev.target).addClass('scrollbar-handle-down-move');
            ...
            $(document).one('mouseup.arrows', function(){
                clearInterval(timer);
                $(ev.target).removeClass('scrollbar-handle-up-move scrollbar-handle-down-move');
            });
        },
